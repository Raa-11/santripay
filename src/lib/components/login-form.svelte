  ...
  <div class="w-full max-w-[440px]">
    <div class="overflow-hidden rounded-2xl border bg-card shadow-xl">
      ...
      <div class="relative overflow-hidden bg-primary px-10 py-9">
        ...
        <!-- Decorative circles -->
        <div
          class="pointer-events-none absolute -bottom-12 -right-12 size-48 rounded-full bg-white/10"
        ></div>
        <div
          class="pointer-events-none absolute -top-10 right-16 size-28 rounded-full bg-white/8"
        ></div>
        ...
        <div class="relative flex items-center gap-4">
          <img
            src="/menu.png"
            alt="ITASA"
            class="size-24 shrink-0 rounded-2xl object-contain bg-white/40 shadow-inner"
          />
          <div>
            <p class="text-lg font-bold leading-tight text-white">ITASA</p>
            <p
              class="text-[11px] font-medium tracking-wide text-white/60 uppercase"
            >
      ...
      <div class="px-10 py-8">
        ...
        >
          ...
          <div class="flex items-center gap-2.5">
            ...
            <Label
              for="rememberMe"
              class="cursor-pointer select-none text-sm font-normal text-muted-foreground"
            >
    ...
    <p class="mt-5 text-center text-xs text-muted-foreground/40">
      &copy; {new Date().getFullYear()} ITASA &mdash; Hak cipta dilindungi.
    </p>
  </div>
</div>
